...
const RoomDetails = (props: { params: { slug: string } }) => {
    ...
    const { data: room, error, isLoading } = useSWR(`/api/rooms/${slug}`, fetchRoom);
        ...
        <div>
            ...
            <div className="container mx-auto mt-20 ">
                <div className="md:grid md:grid-cols-12 gap-10 px-3">
                            ...
                            <div className="mb-11">
                                ...
                                <div className="grid grid-cols-2">
                                    ...
                                    <div className="flex items-center my-1 md:my-0">
                                        ...
                                        <p className="ml-2 md:text-base text-xs ">Medicine</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="col-span-4 rounded-xl shadow-lg dark:shadow dark:shadow-white sticky top-10 h-fit overflow-auto">
                        <BookRoomCta
